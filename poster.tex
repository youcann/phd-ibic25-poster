...
\begin{document}
	...
	\begin{itemize}
		...
		\item KARA vertical beam size smaller than diffraction limit
		\item Use double slit setup to convert size changes into contrast modulation $V$\textsuperscript{[1, 2]}
		\item In existing setup, $V$ is measured with CMOS camera\textsuperscript{[3]}, $\Rightarrow$ low time resolution
	...
	\end{itemize}
\end{boxgrayw}
\begin{boxgray2w}[\boxheight]{Transverse Beam Excitation and Measurement Setup at KARA}{}
